...
from repos.brainfeatures.utils.data_util import (
    split_into_epochs, apply_window_function, filter_to_frequency_bands,
    reject_windows_with_outliers)
from repos.brainfeatures.feature_generation.wavelet_feature_generator import (
    WaveletFeatureGenerator)
from repos.brainfeatures.feature_generation.frequency_feature_generator import (
    FrequencyFeatureGenerator)
from repos.brainfeatures.feature_generation.phase_feature_generator import (
    PhaseFeatureGenerator)
from repos.brainfeatures.feature_generation.time_feature_generator import (
    TimeFeatureGenerator)
from repos.brainfeatures.utils.data_util import assemble_overlapping_band_limits

# [[0, 2], [2, 4],  [4, 8], [8, 13], [13, 18],  [18, 24], [24, 30], [30, 49.9]]
# [0, 2], [2, 4],  [4, 8], [8, 13], [13, 20], [20, 30], [30, 40], [40, 60]
default_feature_generation_params = {
    "epoch_duration_s": 1,
    "max_abs_val": 800,
    "window_name": "blackmanharris",
    "band_limits": [[0, 4],  [4, 8], [8, 13], [13, 20],  [20, 30], [30, 70]],
    "agg_mode": "median",
