...
def process_one_file(data_set, file_id, out_dir, domains, epoch_duration_s,
    ...
    file_0 = file_name.split("/home/zhangrui/Desktop/EEG_Process/Region/train/AD/")[1]
...
if __name__ == "__main__":
    data_dir = "/home/zhangrui/Desktop/EEG_Process/Region/train/AD/"
    output_dir = "/home/zhangrui/Desktop/EEG_Process/Feature/Region/train/AD/"

    edf_abnormal = EDFAbnormal(data_dir, ".edf", subset="train")
    edf_abnormal.load()
