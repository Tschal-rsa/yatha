...
from repos.brainfeatures.utils.file_util import (pandas_store_as_h5,
                                           replace_extension)
from repos.brainfeatures.preprocessing.preprocess_raw import (preprocess_one_file,
                                                        default_preproc_params)
from repos.brainfeatures.utils.sun_grid_engine_util import determime_curr_file_id
...
if __name__ == "__main__":
    data_dir = "/Users/zhangrui/edf/train/"
